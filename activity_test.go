...
/*
func TestTwitterFollow_Success(t *testing.T) {
...
func TestTwitterFollow_TwitterHandleInvalid(t *testing.T) {
...
func TestTwitterFollow_TwitterHandleBlank(t *testing.T) {
...
func TestTwitterFollow_InvalidToken(t *testing.T) {
